...
const Socials = () => {
    ...
    <div>
        <div className={styles.socialIcons}>
            <a href="https://dev.to/selenecodes" target="blank" aria-label="Dev.to">
                <DevTo height="30" width="30" alt="dev.to/selenecodes"/>
            </a>  
            <a href="https://twitter.com/selene_codes" target="blank" aria-label="Twitter">
                <Twitter height="30" width="30" alt="twitter.com/selene_codes"/>
            </a>  
            <a href="https://linkedin.com/in/selene-blok" target="blank" aria-label="LinkedIn">
            ...
            <a href="https://dribbble.com/selenecodes" target="blank" aria-label="Dribbble">
